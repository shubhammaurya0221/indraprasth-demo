...
function Nav() {
  ...
  return (
    ...
    <div className='lg:w-[20%] w-[40%] lg:pl-[50px] relative left-15 lg:[left-5]'> 
  <img
    src={companylogo}
  ...
  />
     ...
     <div className='w-[30%] lg:flex items-center justify-center gap-4 '>
       ...
       <div className='w-[50px] h-[50px] rounded-full text-white flex items-center justify-center text-[20px] border-2 bg-black  border-white cursor-pointer ml-20' onClick={()=>setShowPro(prev=>!prev)}>
     ...
     {showPro && <div className=' absolute top-[110%] right-[15%] flex items-center flex-col justify-center gap-2 text-[16px] rounded-md bg-[white] px-[15px] py-[10px] border-[2px]  border-black hover:border-white hover:text-white cursor-pointer hover:bg-black  ' >
      ...
      <span className='bg-[black] text-white hover:bg-gray-600  px-[25px] py-[10px] rounded-2xl' onClick={()=>navigate("/allcourses")}>Courses</span>
       </div>}
